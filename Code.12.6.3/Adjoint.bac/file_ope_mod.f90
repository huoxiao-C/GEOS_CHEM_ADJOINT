...
!
      ...
      print*, 'huoxiao_debug max gradient', MAXVAL(State_Chm_Adj%SpeciesAdj(:,:,:,1))
      ENDIF
...
!
      ...
      OPEN( UNIT = 1995, FILE=FILENAME )
         ...
         ! Write each observed quantity to the ics file
         !=================================================================
      WRITE(1995, *) State_Chm_Adj%Species(:,:,:,1)
     ...
     CHARACTER(LEN=20)    :: OUTPUT_GDT_FILE
      ...
      OPEN( UNIT = 1997, FILE=FILENAME )
         ...
         !=================================================================
            ...
            DO J = 1, State_Grid_Adj%NY
            DO I = 1, State_Grid_Adj%NX
               WRITE(1997,*)  State_Chm_Adj%SpeciesAdj(I,J,L,1)
            ENDDO
            ENDDO
            ENDDO
...
!--------------------------------------------------------------------------------
      ...
      !related nc file read
       ...
       CALL Nc_Var_Write( fID=fID, VarName=VarName, Arr4D=State_Chm_Adj%Species )
